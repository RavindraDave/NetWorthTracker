...
import { Cloud, CloudOff, RefreshCw, Download, LogOut, AlertCircle, ExternalLink, KeyRound, X, Lock, LockOpen, Eye, EyeOff, ArrowDownToLine } from 'lucide-react';
...
import { DriveRestoreDialog, formatDate } from './DriveRestoreDialog';
...
export const CloudSyncCard: React.FC = () => {
  ...
  const handleClearClientId = async () => {
    configureClientId('');
    await updatePreferences({ cloudSync: { ...cloudSync, clientId: null, provider: null, enabled: false } });
